...
// Fetch all users
$sql = "SELECT id, username, email, full_name, balance, role, created_at FROM users ORDER BY id ASC";
    ...
    <div class="table-responsive">
        ...
        <?php foreach ($users as $user): ?>
            <tr>
                ...
                <td>
                    <button onclick="editUser(<?php echo $user['id']; ?>, '<?php echo htmlspecialchars($user['email'], ENT_QUOTES, 'UTF-8'); ?>', '<?php echo htmlspecialchars($user['full_name'] ?: '', ENT_QUOTES, 'UTF-8'); ?>','<?php echo htmlspecialchars($user['balance'], ENT_QUOTES, 'UTF-8'); ?>', '<?php echo $user['role']; ?>')" class="btn btn-info">Edit</button>
